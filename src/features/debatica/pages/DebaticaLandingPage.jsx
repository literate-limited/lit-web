// DebaticaLandingPage.jsx — Interactive debate platform welcome
...
import UnfurlingScroll from "../../../landingPages/components/UnfurlingScroll";
...
export default function DebaticaLandingPage() {
  ...
  return (
    <section
      ref={containerRef}
      className={`relative h-screen w-full overflow-hidden bg-[#12081d] transition-all duration-700 ${
    ...
    >
      ...
      <div className="absolute top-6 right-[calc(1.5rem+60px)] z-[9999] pointer-events-auto">
        <button
          ...
          className="
            ...
            shadow-[0_0_25px_rgba(200,100,255,0.15)]
            text-white
            font-semibold
        ...
        >
          ...
          <span className="font-semibold underline underline-offset-4 decoration-white/70 group-hover:decoration-white">
            {t("login")}
          </span>
        </button>
      </div>
      ...
      <div className="absolute top-6 inset-x-0 z-30 flex justify-center pointer-events-none">
        <div className="px-10 py-4 bg-white/95 text-[#12081d] rounded-sm shadow-2xl animate-glow font-bold text-xl">
          {t("welcome")}
        </div>
      </div>
      ...
      >
        <button
          ...
          className="
            ...
            bg-white/95
            rounded-full
            shadow-[0_0_35px_rgba(200,100,255,0.65)]
            hover:scale-105
      ...
      <style>{`
        @keyframes ctaBreathe {
          0%, 100% {
            transform: scale(1);
            filter: drop-shadow(0 0 0 rgba(200,100,255,0));
          }
          50% {
            transform: scale(1.03);
            filter: drop-shadow(0 0 12px rgba(200,100,255,0.55));
          }
        }
      `}</style>
    </section>
